    ...
    <section id="hero" className="scroll-mt-24 sm:scroll-mt-28 md:scroll-mt-32 relative min-h-screen pt-32 sm:pt-36 md:pt-44 pb-12 sm:pb-16 overflow-hidden flex items-center">
      ...
      <div className="relative z-10 container-custom w-full px-4 sm:px-6">
        <motion.div
          ...
          className="max-w-2xl"
        >
          {/* Subtítulo 1 - Pequeño arriba */}
          <p className="text-c2 text-xs xs:text-sm sm:text-base md:text-lg font-semibold tracking-wide sm:tracking-widest mb-2">
            {content.hero.subtitle}
          </p>

          {/* Subtítulo 2 - SOMOS ESPECIALISTAS */}
