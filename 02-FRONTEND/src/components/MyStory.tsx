    ...
    <section id="my-story" className="scroll-mt-24 sm:scroll-mt-28 md:scroll-mt-32 py-16 sm:py-20 md:py-28 px-4 bg-c1">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-start">
          ...
          {/* Imagen a la derecha */}
          <div className="relative w-full h-[400px] sm:h-[500px] lg:h-[600px] rounded-xl overflow-hidden shadow-xl">
            <Image
              src="/foto-dra-guadalupe.jpg"
              alt="Dra. María Guadalupe Juárez"
              fill
