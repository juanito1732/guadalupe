  ...
  return (
    <footer className="bg-c5 text-white py-6 sm:py-8 md:py-4">
      <div className="container-custom px-4 sm:px-6">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 items-center gap-6 md:gap-4 mb-4 md:mb-2">
          {/* Logo - Izquierda */}
          ...
          <div className="flex items-center justify-center">
            <p className="text-c1 text-xs sm:text-sm leading-relaxed text-left max-w-2xl md:max-w-3xl lg:max-w-4xl" style={{ textWrap: 'pretty', orphans: 3, widows: 3 }}>
