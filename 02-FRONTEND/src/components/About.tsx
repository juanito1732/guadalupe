        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, idx) => (
            <motion.div
              ...
              className="p-8 bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-xl transition-shadow"
            >
              <div className="mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-primary to-dark rounded-lg flex items-center justify-center text-white">
